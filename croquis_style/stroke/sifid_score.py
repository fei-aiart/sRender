...
from inception_sifid import InceptionV3
import torchvision
import numpy
import scipy
import pickle
...
parser.add_argument('--path2real',default="/home/meimei/mayme/code/sketch_parsing_m3/results/sketch_test_B/", type=str, help=('Path to the real images'))
# parser.add_argument('--path2real',default="/home/meimei/mayme/code/sketch_parsing_m3/results/fid_sketch/", type=str, help=('Path to the real images'))
parser.add_argument('--path2fake', default="/home/meimei/mayme/code/sketch_parsing_m3/results/spade_test/pixHD_test_rename",type=str, help=('Path to generated images'))
...
def get_activations(files, model, batch_size=1, dims=64,
    ...
    for i in tqdm(range(n_batches)):
        ...
        images = np.array([imread(str(fn), mode='RGB').astype(np.float32) for fn in files[start:end]])
